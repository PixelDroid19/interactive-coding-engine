            ...
            {tab === 'learners' && (
              <section className="staff-learners">
                ...
                <div className="staff-learners__detail">
                  ...
                  {selected && <LearnerDetailView detail={selected} feedback={feedback} courseSlug={courseSlug} saving={saving} onBack={() => { setSelectedId(null); setSelected(null); }} onFeedback={setFeedback} onCourse={setCourseSlug} onSend={() => void sendFeedback()} />}
                </div>
              </section>
            )}
            {tab === 'inbox' && (
