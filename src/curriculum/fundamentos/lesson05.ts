...
- si no → F`,
        tests: [
          {
            id: 'tiene-a',
            description: 'Hay un camino para A con 90',
            validatorType: 'source-regex',
            regexPattern: '>=\\s*90[\\s\\S]*A',
            errorMessage: 'Si nota >= 90, devuelve "A".',
            hintTip: 'if (nota >= 90) return "A";',
          },
          {
            id: 'tiene-f',
            description: 'Si no entra en A/B/C, es F',
            validatorType: 'source-regex',
            regexPattern: '["\']F["\']',
            errorMessage: 'El último camino tiene que devolver "F".',
            hintTip: 'return "F";',
          },
        ],
        hints: [
