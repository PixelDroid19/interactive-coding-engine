...
export const ADVANCED_DEBUG_EXERCISES: DebuggingExerciseItem[] = [
  ...
  debug({ number: 17, title: 'El diagrama perdió dos caminos', expected: 'Cero se clasifica como “cero” y un número negativo como “negativo”.', observed: 'Cero cae en “positivo” y los negativos caen en “cero”.', starter: 'function clasificarSaldo(saldo) {\n  if (saldo >= 0) return "positivo";\n  return "cero";\n}\nconsole.log(clasificarSaldo(0));', tests: [
