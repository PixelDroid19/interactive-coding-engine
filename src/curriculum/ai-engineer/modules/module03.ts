...
print(seleccionar_bloques([4, 3, 5], 7))`, starter: `def seleccionar_bloques(costos, presupuesto):
    ...
    reasoning: { activity: sequenceActivity('Ordena el selector.', [['permisos', 'Filtrar permisos'], ['vigencia', 'Filtrar vigencia'], ['ordenar', 'Ordenar utilidad'], ['presupuesto', 'Añadir mientras cabe'], ['traza', 'Registrar descartes']]), explanation: 'Los filtros duros protegen antes de puntuar. El presupuesto opera sobre el orden resultante.', hints: ['Permisos no dependen de similitud.', 'La traza se completa con la decisión.'] },
