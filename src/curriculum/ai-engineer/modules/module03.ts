...
print(compactar(["a", "b", "c"], 2))`, starter: `def compactar(historial, maximo):
  ...
  authoredLesson({
    number: 22, module: 3, title: 'Aislamiento y fallos de contexto',
    summary: 'Aplica seguridad de contexto: detecta instrucciones incrustadas y separa datos entre usuarios y agentes.',
