...
print(etiqueta_prioridad(8))`, starter: `def etiqueta_prioridad(puntos):
    ...
    reading: { core: 'Zero-shot confía en una descripción suficiente. Few-shot añade ejemplos para mostrar etiquetas, tono o transformaciones. Los ejemplos deben representar fronteras, variación y casos difíciles.', mechanics: 'Los ejemplos se incluyen en el contexto y afectan la distribución de salida. No modifican los pesos. El modelo infiere el patrón durante esa llamada. El laboratorio repite exactamente la misma entrada para que la comparación sea justa.', decisions: 'Empieza sin ejemplos y mide. Añade el mínimo ejemplo que resuelva un fallo observado. Incluye contraejemplos y casos límite cuando la frontera sea importante.', errors: 'Un ejemplo con datos reales puede filtrar información. Ejemplos contradictorios confunden. Repetir siempre la misma forma puede producir imitación superficial en vez de generalización.', keyPoints: ['Few-shot cambia el contexto, no los pesos.', 'Los casos límite enseñan fronteras.', 'Los ejemplos también se evalúan por privacidad.'], question: '¿Cuántos ejemplos necesito?', answer: 'Los mínimos que mejoren el conjunto de evaluación sin consumir contexto innecesario. La respuesta se obtiene experimentando, no por una cifra universal.', transfer: 'Escribe un ejemplo positivo, uno negativo y uno de frontera para clasificar urgencia.', sources: ['google-prompt-design', 'transformers-js', 'openai-prompting', 'anthropic-prompt-engineering'] },
