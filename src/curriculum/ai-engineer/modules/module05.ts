...
print(ordenar_resultados([{"id": "a", "puntuacion": 0.2}, {"id": "b", "puntuacion": 0.9}]))`, starter: `def ordenar_resultados(resultados):
    ...
    reasoning: { activity: sequenceActivity('Ordena una búsqueda semántica.', [['consulta', 'Crear embedding de consulta'], ['buscar', 'Buscar vecinos'], ['filtrar', 'Aplicar permisos y metadatos'], ['ordenar', 'Ordenar candidatos'], ['decidir', 'Usar o abstenerse']]), explanation: 'Permisos pueden aplicarse dentro de la consulta; conceptualmente siempre protegen antes de entregar candidatos.', hints: ['La consulta necesita embedding.', 'El primer vecino no es todavía respuesta.'] },
